...
function createElement(appendTo, img, p, pURL, c1, c2, c3, c4, c5) {
	...
	let elem = `<div class="color_palette">
			<div class="palette">
				<div class="img">
					<img src="${img}" alt="Tyler">
					<div class="imgFoot">
						Shot by <a href="${pURL}">${p}</a>
					</div>
				</div>
				<div class="colors">
					<div class="color" style="background:${c1}" data-c='${c1}'><p>${c1}</p></div>
					<div class="color" style="background:${c2}" data-c='${c2}'><p>${c2}</p></div>
					<div class="color" style="background:${c3}" data-c='${c3}'><p>${c3}</p></div>
					<div class="color" style="background:${c4}" data-c='${c4}'><p>${c4}</p></div>
					<div class="color" style="background:${c5}" data-c='${c5}'><p>${c5}</p></div>
				</div>
			</div>
			<div class="cFoot">
